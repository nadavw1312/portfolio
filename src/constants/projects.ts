...
const projects = [
  {
    ...
    skills: [skills.Vue, skills.TypeScript, skills.NodeJS, skills.Express, skills.MongoDB, skills.AWS],
  ...
  },
  {
    ...
    associated: ["Associated with WeDev"],
    skills: [skills.Nuxt, skills.TypeScript, skills.NodeJS, skills.Express, skills.MongoDB, skills.AWS],
